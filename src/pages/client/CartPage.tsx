                  ...
                  {fechasEntrega && (
                    <div className="bg-primary-container/30 dark:bg-[#e3b54a]/10 p-4 rounded-xl border border-primary/20 dark:border-[#e3b54a]/20 mt-4 mb-4">
                      ...
                      <p className="text-sm text-on-surface dark:text-white/90">
                        Entre el <span className="font-bold">{new Date(fechasEntrega.inicio + "T12:00:00").toLocaleDateString('es-HN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</span> y el <span className="font-bold">{new Date(fechasEntrega.fin + "T12:00:00").toLocaleDateString('es-HN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</span>
                      </p>
                    </div>
                  )}
