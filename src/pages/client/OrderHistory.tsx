                  ...
                  {pedido.fecha_entrega_esperada_inicio && pedido.fecha_entrega_esperada_fin && (
                    <div className="mt-2 bg-primary/10 dark:bg-[#e3b54a]/10 px-3 py-1.5 rounded-md inline-block">
                      ...
                      <p className="text-sm font-medium text-on-surface dark:text-white">
                        {new Date(pedido.fecha_entrega_esperada_inicio + "T12:00:00").toLocaleDateString('es-HN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })} a {new Date(pedido.fecha_entrega_esperada_fin + "T12:00:00").toLocaleDateString('es-HN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
                      </p>
                    </div>
                  )}
                </div>
