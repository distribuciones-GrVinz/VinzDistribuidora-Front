                ...
                <button
                  ...
                  className={`whitespace-nowrap px-6 py-2.5 rounded-full font-bold text-sm transition-all shadow-sm border ${
                    activeCategory === cat 
                      ...
                      : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50 hover:border-gray-300 dark:bg-black/40 dark:text-white/70 dark:border-white/10 hover:text-black dark:hover:text-white dark:hover:bg-white/10'
                  }`}
                >
                  {cat}
                </button>
