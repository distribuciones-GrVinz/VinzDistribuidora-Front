  ...
  return (
    <div className="max-w-7xl mx-auto py-8 mb-20 transition-colors duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 mt-8">
        ...
        <button className="bg-primary-container dark:bg-[#e3b54a] text-white dark:text-black px-6 py-3 rounded-full font-bold flex items-center gap-2 hover:bg-tertiary dark:hover:bg-white transition-all shadow-md dark:shadow-[0_0_20px_rgba(227,181,74,0.3)]">
